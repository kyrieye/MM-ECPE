...
class EmotionCaptioningNetwork(nn.Module):
    def __init__(self, vis_encoder, phr_encoder, decoder, emotion_attention, max_caption_len, vocab, PS_threshold,app_feat):
    ...
    def describe(self, vis_feats,pos_em_word,sub_mode):
        batch_size = vis_feats[self.app_feat].size(0)
        vocab_size = self.decoder.output_size
